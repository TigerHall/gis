...
当前开发中的付费高级功能（GeoJSON 下载等），内测期间免费开放。

**内测激活码**：`837291`

在地图设置 → 高级 → 高级功能 中输入即可激活。
...
| GEBCO      | 全球权威水深格网数据（GEBCO_2024 Grid），WMS 服务         |
| EMODnet    | 欧洲海洋数据网络水深服务，1/16弧分分辨率                  |
| Macrostrat | 全球统一地质图（225+ 源图协调），XYZ 瓦片                 |
